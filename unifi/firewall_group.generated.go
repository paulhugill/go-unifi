...
func (c *Client) listFirewallGroup(ctx context.Context, site string) ([]FirewallGroup, error) {
	...
	err := c.do(ctx, "GET", fmt.Sprintf("proxy/network/api/s/%s/rest/firewallgroup", site), nil, &respBody)
	if err != nil {
		return nil, err
	}
...
func (c *Client) getFirewallGroup(ctx context.Context, site, id string) (*FirewallGroup, error) {
	...
	err := c.do(ctx, "GET", fmt.Sprintf("proxy/network/api/s/%s/rest/firewallgroup/%s", site, id), nil, &respBody)
	if err != nil {
		return nil, err
	}
...
func (c *Client) deleteFirewallGroup(ctx context.Context, site, id string) error {
	err := c.do(ctx, "DELETE", fmt.Sprintf("proxy/network/api/s/%s/rest/firewallgroup/%s", site, id), struct{}{}, nil)
	if err != nil {
		return err
	}
	return nil
...
func (c *Client) createFirewallGroup(ctx context.Context, site string, d *FirewallGroup) (*FirewallGroup, error) {
	...
	err := c.do(ctx, "POST", fmt.Sprintf("proxy/network/api/s/%s/rest/firewallgroup", site), d, &respBody)
	if err != nil {
		return nil, err
	}
...
func (c *Client) updateFirewallGroup(ctx context.Context, site string, d *FirewallGroup) (*FirewallGroup, error) {
	...
	err := c.do(ctx, "PUT", fmt.Sprintf("proxy/network/api/s/%s/rest/firewallgroup/%s", site, d.ID), d, &respBody)
	if err != nil {
		return nil, err
	}
