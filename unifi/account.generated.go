...
func (c *Client) listAccount(ctx context.Context, site string) ([]Account, error) {
	...
	err := c.do(ctx, "GET", fmt.Sprintf("proxy/network/api/s/%s/rest/account", site), nil, &respBody)
	if err != nil {
		return nil, err
	}
...
func (c *Client) getAccount(ctx context.Context, site, id string) (*Account, error) {
	...
	err := c.do(ctx, "GET", fmt.Sprintf("proxy/network/api/s/%s/rest/account/%s", site, id), nil, &respBody)
	if err != nil {
		return nil, err
	}
...
func (c *Client) deleteAccount(ctx context.Context, site, id string) error {
	err := c.do(ctx, "DELETE", fmt.Sprintf("proxy/network/api/s/%s/rest/account/%s", site, id), struct{}{}, nil)
	if err != nil {
		return err
	}
	return nil
...
func (c *Client) createAccount(ctx context.Context, site string, d *Account) (*Account, error) {
	...
	err := c.do(ctx, "POST", fmt.Sprintf("proxy/network/api/s/%s/rest/account", site), d, &respBody)
	if err != nil {
		return nil, err
	}
...
func (c *Client) updateAccount(ctx context.Context, site string, d *Account) (*Account, error) {
	...
	err := c.do(ctx, "PUT", fmt.Sprintf("proxy/network/api/s/%s/rest/account/%s", site, d.ID), d, &respBody)
	if err != nil {
		return nil, err
	}
