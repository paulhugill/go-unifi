...
func (c *Client) listDashboard(ctx context.Context, site string) ([]Dashboard, error) {
	...
	err := c.do(ctx, "GET", fmt.Sprintf("proxy/network/api/s/%s/rest/dashboard", site), nil, &respBody)
	if err != nil {
		return nil, err
	}
...
func (c *Client) getDashboard(ctx context.Context, site, id string) (*Dashboard, error) {
	...
	err := c.do(ctx, "GET", fmt.Sprintf("proxy/network/api/s/%s/rest/dashboard/%s", site, id), nil, &respBody)
	if err != nil {
		return nil, err
	}
...
func (c *Client) deleteDashboard(ctx context.Context, site, id string) error {
	err := c.do(ctx, "DELETE", fmt.Sprintf("proxy/network/api/s/%s/rest/dashboard/%s", site, id), struct{}{}, nil)
	if err != nil {
		return err
	}
	return nil
...
func (c *Client) createDashboard(ctx context.Context, site string, d *Dashboard) (*Dashboard, error) {
	...
	err := c.do(ctx, "POST", fmt.Sprintf("proxy/network/api/s/%s/rest/dashboard", site), d, &respBody)
	if err != nil {
		return nil, err
	}
...
func (c *Client) updateDashboard(ctx context.Context, site string, d *Dashboard) (*Dashboard, error) {
	...
	err := c.do(ctx, "PUT", fmt.Sprintf("proxy/network/api/s/%s/rest/dashboard/%s", site, d.ID), d, &respBody)
	if err != nil {
		return nil, err
	}
